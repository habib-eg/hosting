...
class DRSAPI extends DomainAPI implements IDomainAPI
{
     ...
     */
    public function __construct(object $Registrar)
    {
        //exit();
     ...
     * @return int|mixed
     */
    public function changeContactPerson($DomainOrder, $owner)
    {
     ...
     * @return int|mixed
     */
    public function createContactPerson($owner, $c_id = null)
    {
        $names = explode(' ', $owner->fio);
        $last_name = $names[0];
        $first_name = $names[1];
     ...
     * @return int|mixed
     */
    public function registerDomain($DomainOrder, $Owner)
    {

        $ns1 = $DomainOrder->dns1;
        $ns1ip = $DomainOrder->ip1;
        $ns2 = $DomainOrder->dns2;
        $ns2ip = $DomainOrder->ip2;
        $ns3 = $DomainOrder->dns3;
        $ns3ip = $DomainOrder->ip3;
        $ns4 = $DomainOrder->dns4;
        $ns4ip = $DomainOrder->ip4;
